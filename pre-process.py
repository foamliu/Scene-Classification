...
def extract(usage, package, image_path, json_path):
    if not os.path.exists('data/'.format(package)):
...
if __name__ == '__main__':
    ...
    extract('test_a', 'ai_challenger_scene_test_a_20180103', 'scene_test_a_images_20180103',
            'scene_test_a_annotations_20180103.json')

    extract('test_b', 'ai_challenger_scene_test_b_20180103', 'scene_test_b_images_20180103',
